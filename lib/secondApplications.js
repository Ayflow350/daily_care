            ...
            <Container style={container}>
              <Section style={section}>
                <>
                  ...
                  <Column style={ideas}>
                    ...
                    <Section style={yellowCard}>
                      <b style={subtitle}>Contact you at work?</b>
                      <Text style={textCard}>yes</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>I have a work permit?</b>
                      <Text style={textCard}>yes</Text>
                    </Section>
                    <Section style={yellowCard}>
                    ...
                    <Section style={yellowCard}>
                      <b style={subtitle}> Work eligibility in the U.S?</b>
                      <Text style={textCard}>{workTelephone}</Text>
                    </Section>
                  </Column>
              ...
              <Section style={section}>
                <>
                  <Column style={ideas}>
                    <Section style={yellowCard}>
                      <b style={subtitle}>HIGH SCHOOL Info</b>
