...
const data = {
  ...
  correspondenceAddress: "PO Box 1234, Anytown, USA",
  homePhone: "123-456-7890",
  workTelephone: "098-765-4321",
  contactAtWork: "HR",
  eligibleToWork: "Yes",
  workPermitOrVisa: "No",
  highSchoolNameAndAddress: "Anytown High School, Anytown, USA",
  highSchoolDateAttended: "2010-2014",
  highSchoolAreaOfStudy: "General Studies",
  highSchoolDiploma: "Yes",
  collegesTrainingSchools: "Anytown College",
  collegeDateAttended: "2014-2018",
  collegeAreaOfStudy: "Computer Science",
  collegeDiploma: "Bachelor",
  professionalTrainings: "React, Node.js, AWS Certifications",
};
        ...
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            ...
            <Container style={container}>
                ...
                <>
                  ...
                  <Column style={ideas}>
                    <Section style={yellowCard}>
                      ...
                      <Text style={textCard}>{workTelephone}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>May we contact you at work?</b>
                      <Text style={textCard}>yes</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Do you have a work permit?</b>
                      <Text style={textCard}>yes</Text>
                    </Section>
                    <Section style={yellowCard}>
                      <b style={subtitle}>HOME PHONE</b>
                      <Text style={textCard}>{homePhone}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>I am eligible to work in the U.S?</b>
                      <Text style={textCard}>{workTelephone}</Text>
                    </Section>
                  </Column>
              ...
              <Text style={styles.paragraph}>
                With Daily Care Services' extensive network of caregivers, we
                can connect you with the ideal person to meet your specific
                needs.
              </Text>
              ...
              <Section style={section}>
                <>
                  <Column style={ideas}>
                    <Section style={yellowCard}>
                      <b style={subtitle}>HIGH SCHOOL NAME AND ADDRESS</b>
                      <Text style={textCard}>{highSchoolNameAndAddress}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Date Attended</b>
                      <Text style={textCard}>{highSchoolDateAttended}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Area of Study:</b>
                      <Text style={textCard}>{highSchoolAreaOfStudy}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Diploma Received?</b>
                      <Text style={textCard}>{highSchoolDiploma}</Text>
                    </Section>
                  </Column>
                  ...
                  <Column style={ideas}>
                    <Section style={yellowCard}>
                      <b style={subtitle}>Date Attended</b>
                      <Text style={textCard}>{collegeDateAttended}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Area of Study</b>
                      <Text style={textCard}>{collegeAreaOfStudy}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Diploma Received</b>
                      <Text style={textCard}>{collegeDiploma}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Colleges/ Training Schools</b>
                      <Text style={textCard}>{collegesTrainingSchools}</Text>
                    </Section>
                  </Column>
                  <Column style={ideas}></Column>
                  <Section style={section}>
                    <>
                      <Section style={yellowCard}>
                        <b style={subtitle}>Professional trainings</b>
                        <Text style={textCard}>{professionalTrainings}</Text>
                      </Section>
                    </>
                  </Section>
                </>
