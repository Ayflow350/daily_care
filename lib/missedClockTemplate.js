...
const MissedClockEmailTemplate = ({ 
      ...
      <Body style={styles.main}>
        <Container style={styles.container}>
          ...
          <Section style={styles.header}>
            <Row>
              <Column style={styles.headerContent}>
                <Heading style={styles.headerContentTitle}>Information about Missed Clock for the Daily Care Support Services</Heading>
          ...
          <Section style={styles.content}>
            <Heading as="h2" style={styles.title}>Hey!! 🥰   you just received a missed clocks  details from  {fullName}
            ...
            <Text style={styles.paragraph}>
                ...
                <Text style={styles.paragraph} >
                  <b  style={styles.subtitle}>MissedClock: </b>
                 {missedClock}
                </Text>

                
                <Text style={styles.paragraph}>
                  <b  style={styles.subtitle}>  Reasons for missed clocks: </b>
                {Reasons}
                </Text>

                <Text style={styles.paragraph} >
                  <b  style={styles.subtitle}>Date: </b>
                 {Date}
                </Text>

                <Text style={styles.paragraph} >
                  <b  style={styles.subtitle}>Time: </b>
                 {Time}
                </Text>
...
export default MissedClockEmailTemplate;
