      ...
      <Body style={styles.main}>
        <Container style={styles.container}>
          ...
          <Section style={styles.content}>
            <Heading as="h2" style={styles.title}>Hey!! 🥰 You've received a referral from {referrerName}
            ...
            <Text style={styles.paragraph}>
                  <b style={styles.subtitle}> Referrer Name:  </b>
                  {referrerName}
                </Text>
                <Text style={styles.paragraph} >
                  <b  style={styles.subtitle}> Referrer Email:  </b>
                  {referrerEmail}
                </Text>
                <Text style={styles.paragraph}>
                  <b  style={styles.subtitle}>   Referee Email:  </b>
                  
                  {refereeName}
                </Text>
                <Text style={styles.paragraph}>
                  <b  style={styles.subtitle}>  Referee Name:  </b>
                  {refereeEmail}
                </Text>

                <Text style={styles.paragraph}>
                  <b  style={styles.subtitle}>   Referee Phone: </b>
                  {refereePhone}
                </Text>
