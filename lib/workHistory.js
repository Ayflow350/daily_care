          ...
          <Section style={styles.content}>
            ...
            <Container style={styles.container}>
              <Section style={styles.section}>
                <>
                  <Column style={styles.ideas}>
                    <Section style={styles.yellowCard}>
                      <b style={styles.subtitle}> Mr/Mrs:</b>
                      <Text style={styles.textCard}>{mrMrs}</Text>
                    </Section>

                    <Section style={styles.yellowCard}>
                      <b style={styles.subtitle}>First Name</b>
                      <Text style={styles.textCard}>{firstName}</Text>
                    </Section>

                    <Section style={styles.yellowCard}>
                      <b style={styles.subtitle}> Last Name</b>
                      <Text style={styles.textCard}>{lastName}</Text>
                    </Section>

                    <Section style={styles.yellowCard}>
                      <b style={styles.subtitle}>Home Address</b>
                      <Text style={styles.textCard}>{homeAddress}</Text>
                    </Section>
                    <Section style={styles.yellowCard}>
                      <b style={styles.subtitle}>
                        Are you eligible to work in the U.S?
                      </b>
                      <Text style={styles.textCard}>{eligibleToWork}</Text>
                    </Section>
                  </Column>

                  <Column style={styles.ideas}>
                    <Section style={styles.yellowCard}>
                      <b style={styles.subtitle}>Correspondence Address</b>
                    ...
                    <Section style={styles.yellowCard}>
                      <b style={styles.subtitle}>Home Phone</b>
                      <Text style={styles.textCard}>{homePhone}</Text>
                    </Section>
                    ...
                    <Section style={styles.yellowCard}>
                      ...
                      <Text style={styles.textCard}> {workPermitOrVisa}</Text>
                    </Section>
