                ...
                <>
                  <Column style={ideas}>
                    <Section style={yellowCard}>
                      ...
                      <Text style={textCard}>{employer}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Dates (month/year)</b>
                      <Text style={textCard}>{dates}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Postion Held</b>
                      <Text style={textCard}>{position}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Reason for leaving</b>
                      <Text style={textCard}>{reason}</Text>
                    </Section>
                  </Column>
                  ...
                  <Column style={ideas}>
                    <Section style={yellowCard}>
                      ...
                      <Text style={textCard}>{startingSalary}</Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>Ending Salary</b>
                      <Text style={textCard}>{endingSalary}</Text>
                    </Section>
                    ...
                    <Section style={yellowCard}>
                      ...
                      <Text style={textCard}>
                        {" "}
                        Yes you can contact her{contactEmployer}
                      </Text>
                    </Section>

                    <Section style={yellowCard}>
                      <b style={subtitle}>If No, please indicate reason:</b>
                      <Text style={textCard}>{message}</Text>
                    </Section>
                  </Column>
                </>
              </Section>
